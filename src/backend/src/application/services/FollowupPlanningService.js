...
exports.FollowupPlanningService = void 0;
...
function defaultEducationAdvice(riskLevel) {
    if (riskLevel === 'L3') {
...
var FollowupPlanningService = /** @class */ (function () {
    function FollowupPlanningService() {
    }
    FollowupPlanningService.prototype.buildPlan = function (input) {
        var followupDays = 90;
        ...
        return {
            ...
            destination: input.triageLevel === 'emergency'
                ? 'offline_emergency'
                : DEPARTMENT_DESTINATION[input.department],
            followupDays: followupDays,
            educationAdvice: defaultEducationAdvice(input.riskLevel),
            tcmAdvice: input.riskLevel === 'L0' || input.riskLevel === 'L1'
                ? ['可结合中医体质调理，作为长期管理增强建议']
                : undefined,
        };
    };
    return FollowupPlanningService;
}());
exports.FollowupPlanningService = FollowupPlanningService;
