...
exports.GPAgent = void 0;
var AgentBase_1 = require("./AgentBase");
var GPAgent = /** @class */ (function (_super) {
    __extends(GPAgent, _super);
    function GPAgent(llmClient) {
        var _this = _super.call(this, 'gp_01', '全科会诊代理', 'Generalist') || this;
        _this.llmClient = llmClient !== null && llmClient !== void 0 ? llmClient : null;
        return _this;
    }
    GPAgent.prototype.buildFallbackOpinion = function () {
        return {
            agentId: this.id,
            agentName: this.name,
            role: this.role,
    ...
    GPAgent.prototype.think = function (profile, context) {
        return __awaiter(this, void 0, void 0, function () {
            var fallback, llmOpinion, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        fallback = this.buildFallbackOpinion();
                        if (!this.llmClient) {
